// I assume that most of the formatting issues come from the pdf conversion, therefore I upload a version which is
// formatted by me

// In my past projects when using UIKit, we preferred to build up ui programatically, without interface builder, since
// it resuts faster code. I assume that in this task it is alright to use IB
